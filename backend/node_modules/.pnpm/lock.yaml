...
importers:
  ...
  .:
    dependencies:
      ...
      bullmq:
        specifier: ^6.0.9
        version: 6.0.9(ioredis@6.0.0(supports-color@5.5.0))(redis@6.2.0)
      cors:
        specifier: ^2.8.6
        version: 2.8.6
      dotenv:
...
packages:
  ...
  bullmq@6.0.9:
    resolution: {integrity: sha512-l7kNlirauwdZrqsViO6owHUAhSSN/aCDkrUwZQ2futIItlbJGAxgU+6IOQtTl5Re39GZJEPU6jelGuY1gQD28w==}
...
snapshots:
  ...
  '@redis/bloom@6.2.0(@redis/client@6.2.0)':
    dependencies:
      '@redis/client': 6.2.0
  ...
  '@redis/json@6.2.0(@redis/client@6.2.0)':
    dependencies:
      '@redis/client': 6.2.0

  '@redis/search@6.2.0(@redis/client@6.2.0)':
    dependencies:
      '@redis/client': 6.2.0

  '@redis/time-series@6.2.0(@redis/client@6.2.0)':
    dependencies:
      '@redis/client': 6.2.0
  ...
  bullmq@6.0.9(ioredis@6.0.0(supports-color@5.5.0))(redis@6.2.0):
    dependencies:
      cron-parser: 5.7.0
      msgpackr: 2.0.5
      node-abort-controller: 3.1.1
