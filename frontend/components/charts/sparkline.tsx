...
export function Sparkline({
  ...
  if (valid.length < 2) {
    return (
      <svg width={width} height={height} role="img" aria-label="Not enough data to chart a trend">
        <text x={width / 2} y={height / 2} textAnchor="middle" fontSize="12" fill="var(--color-text-muted)">
          Not enough data yet
        </text>
      </svg>
    );
