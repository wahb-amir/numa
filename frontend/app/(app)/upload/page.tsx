    ...
    <div>
      ...
      <div className="mx-auto max-w-2xl space-y-6 px-4 py-6 lg:px-8 lg:py-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <dd className="mt-0.5 text-xs text-text-muted">
                  Export from Garmin Connect, Apple Health (via shortcuts), or
                  any spreadsheet with columns: date, activity_type,
                  duration_seconds, and optional metrics.
                </dd>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <dd className="mt-0.5 text-xs text-text-muted">
                  Standard GPS track files exported from Strava, Wahoo, Garmin,
                  or most cycling and running apps.
                </dd>
              </div>
            </div>
          </dl>
        ...
        <p className="text-center text-xs text-text-muted">
          Files are uploaded directly and securely to your private storage
          bucket. Numa never shares your data with third parties.
        </p>
      </div>
    </div>
  );
