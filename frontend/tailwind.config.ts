  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "display-lg": ["2.75rem", { lineHeight: "1.08", letterSpacing: "-0.015em", fontWeight: "700" }],
        "display-md": ["2rem", { lineHeight: "1.15", letterSpacing: "-0.01em", fontWeight: "700" }],
        "editorial-num": ["2.5rem", { lineHeight: "1", letterSpacing: "-0.02em", fontWeight: "600" }],
      },
      borderRadius: {
        card: "4px",
        chip: "2px",
      ...
      boxShadow: {
        "elevation-1": "0 1px 2px rgba(28, 27, 23, 0.04), 0 1px 1px rgba(28, 27, 23, 0.03)",
        "elevation-2": "0 4px 12px rgba(28, 27, 23, 0.06), 0 1px 2px rgba(28, 27, 23, 0.04)",
        "elevation-3": "0 12px 32px rgba(28, 27, 23, 0.10), 0 2px 6px rgba(28, 27, 23, 0.05)",
      },
